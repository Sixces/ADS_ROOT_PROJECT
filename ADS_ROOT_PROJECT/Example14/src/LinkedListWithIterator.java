// CS 0445 Fall 2021
// I have taken the author's code and added an extra instance variable,
// count, and two methods, clearCount() and getCount().  The count variable  
// will keep track of the operations required to traverse the list for various
// operations.  To distinguish between my code and the author's, I have put 
// comments /****/ above and below all of my code segments.
             ...
             implements ListWithIteratorInterface<T>
{
   ...
   /*****************/
   private int count;  // My added instance variable
   /*****************/
   ...
   public LinkedListWithIterator()
   {
	...
	public void clear()
	{
 	...
 	/************************************************************/
	// Method to initialize the count variable to 0
