...
// To run this compile and run on the command line with an int command line
// argument.  The command line argument indicates the length of the pause
// between moves in milliseconds.  For example:
//
// java JRQueens 1000
//
// will delay 1000 milliseconds, or 1 second between moves.
