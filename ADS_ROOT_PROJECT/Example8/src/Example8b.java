...
public class Example8b
{
    ...
    public static void main(String [] args)
    {
        ...
        // Example7.java.  Also note that the standard list is indexed from
        ...
        for (int i = 0; i < 5; i++)
        {
            Integer findI = new Integer(R.nextInt(20));
            if (L.contains(findI))
        ...
        Integer newI = new Integer(Integer.parseInt(
                JOptionPane.showInputDialog(null,
                        "Enter new item")));

        // Note that in Example7.java, the add() below was in an if
        ...
        newI = new Integer(Integer.parseInt(
                JOptionPane.showInputDialog(null,
                        "Enter new value")));
        try
        {
