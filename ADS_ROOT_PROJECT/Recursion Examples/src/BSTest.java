...
// search of a large array) execute the program as follows:
// java -Xss10M BSTest
// The above increases the run-time stack size to 10 megabytes.  You can make
// it even larger if you would like.
...
public class BSTest
{
    ...
    public void runTest()
    {
        ...
        {
            item = Integer.valueOf((int) (Math.random() * 50000));
    ...
    {
        for (int i = low; i < high; i++) System.out.print(" ");  // indent to indicate call level
